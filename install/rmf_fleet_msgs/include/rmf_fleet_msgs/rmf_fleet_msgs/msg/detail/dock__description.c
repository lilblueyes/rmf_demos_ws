...
static char rmf_fleet_msgs__msg__Dock__FIELD_NAME__fleet_name[] = "fleet_name";
static char rmf_fleet_msgs__msg__Dock__FIELD_NAME__params[] = "params";

static rosidl_runtime_c__type_description__Field rmf_fleet_msgs__msg__Dock__FIELDS[] = {
  {
    {rmf_fleet_msgs__msg__Dock__FIELD_NAME__fleet_name, 10, 10},
    {
  ...
  {
    {rmf_fleet_msgs__msg__Dock__FIELD_NAME__params, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_fleet_msgs__msg__Dock__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_fleet_msgs__msg__Dock__FIELDS, 2, 2},
    },
    {rmf_fleet_msgs__msg__Dock__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = rmf_fleet_msgs__msg__DockParameter__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[2].fields = rmf_fleet_msgs__msg__Location__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_fleet_msgs__msg__Dock__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *rmf_fleet_msgs__msg__DockParameter__get_individual_type_description_source(NULL);
    sources[3] = *rmf_fleet_msgs__msg__Location__get_individual_type_description_source(NULL);
    constructed = true;
  }
