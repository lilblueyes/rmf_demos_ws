...
inline std::string to_yaml(const ModeParameter & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rmf_fleet_msgs::msg::ModeParameter & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rmf_fleet_msgs::msg::ModeParameter & msg)
{
