...
rmf_fleet_msgs__msg__MutexGroupAssignment__init(rmf_fleet_msgs__msg__MutexGroupAssignment * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->group)) {
    rmf_fleet_msgs__msg__MutexGroupAssignment__fini(msg);
    return false;
  }
  // claimant
  // claim_time
...
rmf_fleet_msgs__msg__MutexGroupAssignment__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_fleet_msgs__msg__MutexGroupAssignment * msg = (rmf_fleet_msgs__msg__MutexGroupAssignment *)allocator.allocate(sizeof(rmf_fleet_msgs__msg__MutexGroupAssignment), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmf_fleet_msgs__msg__MutexGroupAssignment));
  bool success = rmf_fleet_msgs__msg__MutexGroupAssignment__init(msg);
  if (!success) {
...
rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence__init(rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_fleet_msgs__msg__MutexGroupAssignment * data = NULL;

  if (size) {
    data = (rmf_fleet_msgs__msg__MutexGroupAssignment *)allocator.zero_allocate(size, sizeof(rmf_fleet_msgs__msg__MutexGroupAssignment), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmf_fleet_msgs__msg__MutexGroupAssignment__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rmf_fleet_msgs__msg__MutexGroupAssignment__fini(&data[i - 1]);
      }
...
rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence__fini(rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rmf_fleet_msgs__msg__MutexGroupAssignment__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * array = (rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence *)allocator.allocate(sizeof(rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence__init(array, size);
  if (!success) {
...
rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence__destroy(rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence__are_equal(const rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * lhs, const rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmf_fleet_msgs__msg__MutexGroupAssignment__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmf_fleet_msgs__msg__MutexGroupAssignment__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmf_fleet_msgs__msg__MutexGroupAssignment);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rmf_fleet_msgs__msg__MutexGroupAssignment * data =
      (rmf_fleet_msgs__msg__MutexGroupAssignment *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmf_fleet_msgs__msg__MutexGroupAssignment__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rmf_fleet_msgs__msg__MutexGroupAssignment__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmf_fleet_msgs__msg__MutexGroupAssignment__copy(
