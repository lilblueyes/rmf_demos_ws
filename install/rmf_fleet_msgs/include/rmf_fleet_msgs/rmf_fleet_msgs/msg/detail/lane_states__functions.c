...
rmf_fleet_msgs__msg__LaneStates__init(rmf_fleet_msgs__msg__LaneStates * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->fleet_name)) {
    rmf_fleet_msgs__msg__LaneStates__fini(msg);
    return false;
  }
  // closed_lanes
...
rmf_fleet_msgs__msg__LaneStates__create(void)
{
  ...
  rmf_fleet_msgs__msg__LaneStates * msg = (rmf_fleet_msgs__msg__LaneStates *)allocator.allocate(sizeof(rmf_fleet_msgs__msg__LaneStates), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmf_fleet_msgs__msg__LaneStates));
  bool success = rmf_fleet_msgs__msg__LaneStates__init(msg);
  if (!success) {
...
rmf_fleet_msgs__msg__LaneStates__Sequence__init(rmf_fleet_msgs__msg__LaneStates__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_fleet_msgs__msg__LaneStates * data = NULL;

  if (size) {
    data = (rmf_fleet_msgs__msg__LaneStates *)allocator.zero_allocate(size, sizeof(rmf_fleet_msgs__msg__LaneStates), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmf_fleet_msgs__msg__LaneStates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rmf_fleet_msgs__msg__LaneStates__fini(&data[i - 1]);
      }
...
rmf_fleet_msgs__msg__LaneStates__Sequence__fini(rmf_fleet_msgs__msg__LaneStates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rmf_fleet_msgs__msg__LaneStates__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_fleet_msgs__msg__LaneStates__Sequence * array = (rmf_fleet_msgs__msg__LaneStates__Sequence *)allocator.allocate(sizeof(rmf_fleet_msgs__msg__LaneStates__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmf_fleet_msgs__msg__LaneStates__Sequence__init(array, size);
  if (!success) {
...
rmf_fleet_msgs__msg__LaneStates__Sequence__destroy(rmf_fleet_msgs__msg__LaneStates__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmf_fleet_msgs__msg__LaneStates__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmf_fleet_msgs__msg__LaneStates__Sequence__are_equal(const rmf_fleet_msgs__msg__LaneStates__Sequence * lhs, const rmf_fleet_msgs__msg__LaneStates__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmf_fleet_msgs__msg__LaneStates__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmf_fleet_msgs__msg__LaneStates__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmf_fleet_msgs__msg__LaneStates);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rmf_fleet_msgs__msg__LaneStates * data =
      (rmf_fleet_msgs__msg__LaneStates *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmf_fleet_msgs__msg__LaneStates__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rmf_fleet_msgs__msg__LaneStates__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmf_fleet_msgs__msg__LaneStates__copy(
