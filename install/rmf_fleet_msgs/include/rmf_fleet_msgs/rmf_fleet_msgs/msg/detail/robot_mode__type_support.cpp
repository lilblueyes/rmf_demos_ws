...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotMode_message_member_array[3] = {
  {
    "mode",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmf_fleet_msgs::msg::RobotMode, performing_action),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
