...
bool rmf_fleet_msgs__msg__interrupt_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._interrupt_request.InterruptRequest", full_classname_dest, 54) == 0);
  }
  rmf_fleet_msgs__msg__InterruptRequest * ros_message = _ros_message;
  {  // fleet_name
  ...
  {  // interrupt_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "interrupt_id");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->interrupt_id, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // labels
...
{
  /* NOTE(esteve): Call constructor of InterruptRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._interrupt_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InterruptRequest");
  ...
  {  // interrupt_id
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->interrupt_id.data,
      strlen(ros_message->interrupt_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "interrupt_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
