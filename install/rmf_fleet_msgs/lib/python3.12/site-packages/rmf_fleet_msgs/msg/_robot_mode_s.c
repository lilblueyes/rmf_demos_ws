...
bool rmf_fleet_msgs__msg__robot_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._robot_mode.RobotMode", full_classname_dest, 40) == 0);
  }
  rmf_fleet_msgs__msg__RobotMode * ros_message = _ros_message;
  {  // mode
  ...
  {  // performing_action
    PyObject * field = PyObject_GetAttrString(_pymsg, "performing_action");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->performing_action, PyBytes_AS_STRING(encoded_field));
...
PyObject * rmf_fleet_msgs__msg__robot_mode__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._robot_mode");
  ...
  {  // performing_action
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->performing_action.data,
      strlen(ros_message->performing_action.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "performing_action", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
