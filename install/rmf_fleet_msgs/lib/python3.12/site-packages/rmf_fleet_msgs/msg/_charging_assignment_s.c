...
bool rmf_fleet_msgs__msg__charging_assignment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._charging_assignment.ChargingAssignment", full_classname_dest, 58) == 0);
  }
  rmf_fleet_msgs__msg__ChargingAssignment * ros_message = _ros_message;
  {  // robot_name
...
{
  /* NOTE(esteve): Call constructor of ChargingAssignment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._charging_assignment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChargingAssignment");
  ...
  rmf_fleet_msgs__msg__ChargingAssignment * ros_message = (rmf_fleet_msgs__msg__ChargingAssignment *)raw_ros_message;
  {  // robot_name
    PyObject * field = NULL;
