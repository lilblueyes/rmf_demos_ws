...
bool rmf_fleet_msgs__msg__destination_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._destination_request.DestinationRequest", full_classname_dest, 58) == 0);
  }
  rmf_fleet_msgs__msg__DestinationRequest * ros_message = _ros_message;
  {  // fleet_name
  ...
  {  // destination
    ...
    if (!rmf_fleet_msgs__msg__location__convert_from_py(field, &ros_message->destination)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of DestinationRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._destination_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DestinationRequest");
  ...
  {  // destination
    PyObject * field = NULL;
    field = rmf_fleet_msgs__msg__location__convert_to_py(&ros_message->destination);
    if (!field) {
      return NULL;
    }
    {
