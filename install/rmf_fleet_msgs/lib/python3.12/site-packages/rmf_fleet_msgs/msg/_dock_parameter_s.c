...
bool rmf_fleet_msgs__msg__dock_parameter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._dock_parameter.DockParameter", full_classname_dest, 48) == 0);
  }
  rmf_fleet_msgs__msg__DockParameter * ros_message = _ros_message;
  {  // start
  ...
  {  // finish
    ...
    rosidl_runtime_c__String__assign(&ros_message->finish, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // path
...
{
  /* NOTE(esteve): Call constructor of DockParameter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._dock_parameter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DockParameter");
  ...
  {  // finish
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->finish.data,
      strlen(ros_message->finish.data),
      "replace");
    if (!field) {
      return NULL;
    }
