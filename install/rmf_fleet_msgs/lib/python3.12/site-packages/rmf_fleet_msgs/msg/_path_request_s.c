...
bool rmf_fleet_msgs__msg__path_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._path_request.PathRequest", full_classname_dest, 44) == 0);
  }
  rmf_fleet_msgs__msg__PathRequest * ros_message = _ros_message;
  {  // fleet_name
...
{
  /* NOTE(esteve): Call constructor of PathRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._path_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathRequest");
