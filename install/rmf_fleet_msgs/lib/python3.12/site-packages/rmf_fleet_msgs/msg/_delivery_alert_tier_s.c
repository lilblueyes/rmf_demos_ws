...
bool rmf_fleet_msgs__msg__delivery_alert_tier__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._delivery_alert_tier.DeliveryAlertTier", full_classname_dest, 57) == 0);
  }
  rmf_fleet_msgs__msg__DeliveryAlertTier * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of DeliveryAlertTier */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._delivery_alert_tier");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DeliveryAlertTier");
  ...
  rmf_fleet_msgs__msg__DeliveryAlertTier * ros_message = (rmf_fleet_msgs__msg__DeliveryAlertTier *)raw_ros_message;
  {  // value
    PyObject * field = NULL;
