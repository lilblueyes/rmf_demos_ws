...
bool rmf_fleet_msgs__msg__mode_parameter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._mode_parameter.ModeParameter", full_classname_dest, 48) == 0);
  }
  rmf_fleet_msgs__msg__ModeParameter * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of ModeParameter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._mode_parameter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModeParameter");
