...
class Metaclass_LaneStates(type):
    """Metaclass of message 'LaneStates'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rmf_fleet_msgs.msg.LaneStates')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__lane_states
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__lane_states
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__lane_states
            cls._TYPE_SUPPORT = module.type_support_msg__msg__lane_states
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__lane_states
...
class LaneStates(metaclass=Metaclass_LaneStates):
    """Message class 'LaneStates'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.closed_lanes = array.array('Q', kwargs.get('closed_lanes', []))
    ...
    def __eq__(self, other):
        ...
        if self.fleet_name != other.fleet_name:
            return False
        if self.closed_lanes != other.closed_lanes:
            return False
    ...
    @builtins.property
    def closed_lanes(self):
        """Message field 'closed_lanes'."""
        return self._closed_lanes

    @closed_lanes.setter
    def closed_lanes(self, value):
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'Q', \
                    "The 'closed_lanes' array.array() must have the type code of 'Q'"
                self._closed_lanes = value
                return
            ...
            assert \
                ...
                "The 'closed_lanes' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 18446744073709551615]"
        self._closed_lanes = array.array('Q', value)
