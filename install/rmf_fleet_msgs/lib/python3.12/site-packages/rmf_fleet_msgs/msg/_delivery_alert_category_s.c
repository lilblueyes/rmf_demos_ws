...
bool rmf_fleet_msgs__msg__delivery_alert_category__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_fleet_msgs.msg._delivery_alert_category.DeliveryAlertCategory", full_classname_dest, 65) == 0);
  }
  rmf_fleet_msgs__msg__DeliveryAlertCategory * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of DeliveryAlertCategory */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_fleet_msgs.msg._delivery_alert_category");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DeliveryAlertCategory");
  ...
  rmf_fleet_msgs__msg__DeliveryAlertCategory * ros_message = (rmf_fleet_msgs__msg__DeliveryAlertCategory *)raw_ros_message;
  {  // value
    PyObject * field = NULL;
