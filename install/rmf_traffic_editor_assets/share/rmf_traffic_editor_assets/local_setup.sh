...
: ${AMENT_CURRENT_PREFIX:="/rmf_demos_ws/install/rmf_traffic_editor_assets"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_traffic_editor_assets/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_traffic_editor_assets/environment/path.sh"
