...
inline std::string to_yaml(const ApiService_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rmf_task_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rmf_task_msgs::srv::ApiService_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rmf_task_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rmf_task_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rmf_task_msgs::srv::ApiService_Event & msg)
{
  return rmf_task_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rmf_task_msgs::srv::ApiService_Event>()
{
  return "rmf_task_msgs::srv::ApiService_Event";
}

template<>
inline const char * name<rmf_task_msgs::srv::ApiService_Event>()
{
  return "rmf_task_msgs/srv/ApiService_Event";
}

template<>
struct has_fixed_size<rmf_task_msgs::srv::ApiService_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rmf_task_msgs::srv::ApiService_Event>
  : std::integral_constant<bool, has_bounded_size<rmf_task_msgs::srv::ApiService_Request>::value && has_bounded_size<rmf_task_msgs::srv::ApiService_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rmf_task_msgs::srv::ApiService_Event>
  : std::true_type {};
