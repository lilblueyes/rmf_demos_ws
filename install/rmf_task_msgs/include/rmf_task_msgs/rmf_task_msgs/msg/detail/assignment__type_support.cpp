...
{
  new (message_memory) rmf_task_msgs::msg::Assignment(_init);
}

void Assignment_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rmf_task_msgs::msg::Assignment *>(message_memory);
  typed_message->~Assignment();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Assignment_message_member_array[3] = {
  {
    "is_assigned",  // name
    ...
    offsetof(rmf_task_msgs::msg::Assignment, is_assigned),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmf_task_msgs::msg::Assignment, fleet_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmf_task_msgs::msg::Assignment, expected_robot_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Assignment_message_members = {
  ...
  3,  // number of fields
  sizeof(rmf_task_msgs::msg::Assignment),
...
{
  return &::rmf_task_msgs::msg::rosidl_typesupport_introspection_cpp::Assignment_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_task_msgs, msg, Assignment)() {
  return &::rmf_task_msgs::msg::rosidl_typesupport_introspection_cpp::Assignment_message_type_support_handle;
}
