...
void fetch_function__Behavior__parameters(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rmf_task_msgs::msg::BehaviorParameter *>(
    get_const_function__Behavior__parameters(untyped_member, index));
  auto & value = *reinterpret_cast<rmf_task_msgs::msg::BehaviorParameter *>(untyped_value);
  value = item;
}

void assign_function__Behavior__parameters(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rmf_task_msgs::msg::BehaviorParameter *>(
    get_function__Behavior__parameters(untyped_member, index));
  const auto & value = *reinterpret_cast<const rmf_task_msgs::msg::BehaviorParameter *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Behavior_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__Behavior__parameters,  // fetch(index, &value) function pointer
    assign_function__Behavior__parameters,  // assign(index, value) function pointer
