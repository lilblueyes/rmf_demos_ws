...
#ifndef RMF_TASK_MSGS__MSG__DETAIL__DISPATCH_COMMAND__TYPE_SUPPORT_H_
#define RMF_TASK_MSGS__MSG__DETAIL__DISPATCH_COMMAND__TYPE_SUPPORT_H_
...
#endif  // RMF_TASK_MSGS__MSG__DETAIL__DISPATCH_COMMAND__TYPE_SUPPORT_H_
