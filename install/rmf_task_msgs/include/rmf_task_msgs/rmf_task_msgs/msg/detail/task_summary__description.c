  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe0, 0xd5, 0x05, 0xae, 0x36, 0x6e, 0xec, 0xfe,
      0xfa, 0x4f, 0xce, 0x29, 0x0d, 0xdf, 0x9b, 0xcd,
      0xea, 0x07, 0x0a, 0x3d, 0xeb, 0x3e, 0x48, 0xf2,
      0xdf, 0x45, 0x0b, 0x56, 0x49, 0x62, 0x9e, 0xf1,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t rmf_task_msgs__msg__TaskProfile__EXPECTED_HASH = {1, {
...
static char rmf_task_msgs__msg__TaskSummary__TYPE_NAME[] = "rmf_task_msgs/msg/TaskSummary";
...
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__fleet_name[] = "fleet_name";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__task_id[] = "task_id";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__task_profile[] = "task_profile";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__state[] = "state";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__status[] = "status";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__submission_time[] = "submission_time";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__start_time[] = "start_time";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__end_time[] = "end_time";
static char rmf_task_msgs__msg__TaskSummary__FIELD_NAME__robot_name[] = "robot_name";

static rosidl_runtime_c__type_description__Field rmf_task_msgs__msg__TaskSummary__FIELDS[] = {
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__fleet_name, 10, 10},
    {
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__task_id, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__task_profile, 12, 12},
    {
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__state, 5, 5},
    {
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__status, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__submission_time, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__start_time, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__end_time, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {rmf_task_msgs__msg__TaskSummary__FIELD_NAME__robot_name, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_task_msgs__msg__TaskSummary__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rmf_task_msgs__msg__TaskSummary__TYPE_NAME, 29, 29},
      {rmf_task_msgs__msg__TaskSummary__FIELDS, 9, 9},
    },
    {rmf_task_msgs__msg__TaskSummary__REFERENCED_TYPE_DESCRIPTIONS, 12, 12},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&rmf_task_msgs__msg__TaskProfile__EXPECTED_HASH, rmf_task_msgs__msg__TaskProfile__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[10].fields = rmf_task_msgs__msg__TaskProfile__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[11].fields = rmf_task_msgs__msg__TaskType__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_task_msgs__msg__TaskSummary__get_individual_type_description_source(NULL),
    ...
    sources[11] = *rmf_task_msgs__msg__TaskProfile__get_individual_type_description_source(NULL);
    sources[12] = *rmf_task_msgs__msg__TaskType__get_individual_type_description_source(NULL);
    constructed = true;
  }
