  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x34, 0x9b, 0xb5, 0xc5, 0x3b, 0xa0, 0x7d, 0xc0,
      0xf5, 0x9d, 0x99, 0x6d, 0xff, 0xb4, 0xb3, 0xc5,
      0x76, 0xc0, 0x24, 0x23, 0xaf, 0x60, 0xc4, 0xa8,
      0xe7, 0x87, 0x40, 0xee, 0x5c, 0x4e, 0xcf, 0x42,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t rmf_task_msgs__msg__TaskSummary__EXPECTED_HASH = {1, {
...
static char rmf_task_msgs__msg__Tasks__TYPE_NAME[] = "rmf_task_msgs/msg/Tasks";
...
static char rmf_task_msgs__msg__Tasks__FIELD_NAME__tasks[] = "tasks";

static rosidl_runtime_c__type_description__Field rmf_task_msgs__msg__Tasks__FIELDS[] = {
  {
    {rmf_task_msgs__msg__Tasks__FIELD_NAME__tasks, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_task_msgs__msg__Tasks__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rmf_task_msgs__msg__Tasks__TYPE_NAME, 23, 23},
      {rmf_task_msgs__msg__Tasks__FIELDS, 1, 1},
    },
    {rmf_task_msgs__msg__Tasks__REFERENCED_TYPE_DESCRIPTIONS, 13, 13},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&rmf_task_msgs__msg__TaskSummary__EXPECTED_HASH, rmf_task_msgs__msg__TaskSummary__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[11].fields = rmf_task_msgs__msg__TaskSummary__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[12].fields = rmf_task_msgs__msg__TaskType__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
rmf_task_msgs__msg__Tasks__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_task_msgs__msg__Tasks__get_individual_type_description_source(NULL),
    ...
    sources[12] = *rmf_task_msgs__msg__TaskSummary__get_individual_type_description_source(NULL);
    sources[13] = *rmf_task_msgs__msg__TaskType__get_individual_type_description_source(NULL);
    constructed = true;
  }
