...
class Metaclass_ApiService_Event(type):
    """Metaclass of message 'ApiService_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__api_service__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__api_service__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__api_service__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__api_service__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__api_service__event
...
class ApiService_Event(metaclass=Metaclass_ApiService_Event):
    """Message class 'ApiService_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rmf_task_msgs/ApiService_Request, 1>',
        'response': 'sequence<rmf_task_msgs/ApiService_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rmf_task_msgs', 'srv'], 'ApiService_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rmf_task_msgs', 'srv'], 'ApiService_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rmf_task_msgs.srv import ApiService_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ApiService_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ApiService_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rmf_task_msgs.srv import ApiService_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ApiService_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ApiService_Response'"
...
class Metaclass_ApiService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _api_service.Metaclass_ApiService_Event._TYPE_SUPPORT is None:
                _api_service.Metaclass_ApiService_Event.__import_type_support__()
...
class ApiService(metaclass=Metaclass_ApiService):
    ...
    from rmf_task_msgs.srv._api_service import ApiService_Event as Event
