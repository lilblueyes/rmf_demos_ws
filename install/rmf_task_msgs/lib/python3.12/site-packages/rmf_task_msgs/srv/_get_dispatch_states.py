...
class Metaclass_GetDispatchStates_Event(type):
    """Metaclass of message 'GetDispatchStates_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_dispatch_states__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_dispatch_states__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_dispatch_states__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_dispatch_states__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_dispatch_states__event
...
class GetDispatchStates_Event(metaclass=Metaclass_GetDispatchStates_Event):
    """Message class 'GetDispatchStates_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rmf_task_msgs/GetDispatchStates_Request, 1>',
        'response': 'sequence<rmf_task_msgs/GetDispatchStates_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rmf_task_msgs', 'srv'], 'GetDispatchStates_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rmf_task_msgs', 'srv'], 'GetDispatchStates_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rmf_task_msgs.srv import GetDispatchStates_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetDispatchStates_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetDispatchStates_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rmf_task_msgs.srv import GetDispatchStates_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetDispatchStates_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetDispatchStates_Response'"
...
class Metaclass_GetDispatchStates(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_dispatch_states.Metaclass_GetDispatchStates_Event._TYPE_SUPPORT is None:
                _get_dispatch_states.Metaclass_GetDispatchStates_Event.__import_type_support__()
...
class GetDispatchStates(metaclass=Metaclass_GetDispatchStates):
    ...
    from rmf_task_msgs.srv._get_dispatch_states import GetDispatchStates_Event as Event
