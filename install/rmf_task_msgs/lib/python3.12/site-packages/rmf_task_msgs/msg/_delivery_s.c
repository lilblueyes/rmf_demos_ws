...
bool rmf_task_msgs__msg__behavior__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * rmf_task_msgs__msg__behavior__convert_to_py(void * raw_ros_message);
bool rmf_task_msgs__msg__behavior__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * rmf_task_msgs__msg__behavior__convert_to_py(void * raw_ros_message);
...
bool rmf_task_msgs__msg__delivery__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_task_msgs.msg._delivery.Delivery", full_classname_dest, 36) == 0);
  }
  rmf_task_msgs__msg__Delivery * ros_message = _ros_message;
  {  // task_id
  ...
  {  // pickup_dispenser
    PyObject * field = PyObject_GetAttrString(_pymsg, "pickup_dispenser");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->pickup_dispenser, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // pickup_behavior
    PyObject * field = PyObject_GetAttrString(_pymsg, "pickup_behavior");
    if (!field) {
      return false;
    }
    if (!rmf_task_msgs__msg__behavior__convert_from_py(field, &ros_message->pickup_behavior)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // dropoff_ingestor
    PyObject * field = PyObject_GetAttrString(_pymsg, "dropoff_ingestor");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->dropoff_ingestor, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // dropoff_behavior
    PyObject * field = PyObject_GetAttrString(_pymsg, "dropoff_behavior");
    if (!field) {
      return false;
    }
    if (!rmf_task_msgs__msg__behavior__convert_from_py(field, &ros_message->dropoff_behavior)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * rmf_task_msgs__msg__delivery__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_task_msgs.msg._delivery");
  ...
  rmf_task_msgs__msg__Delivery * ros_message = (rmf_task_msgs__msg__Delivery *)raw_ros_message;
  {  // task_id
    PyObject * field = NULL;
  ...
  {  // pickup_dispenser
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->pickup_dispenser.data,
      strlen(ros_message->pickup_dispenser.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "pickup_dispenser", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pickup_behavior
    PyObject * field = NULL;
    field = rmf_task_msgs__msg__behavior__convert_to_py(&ros_message->pickup_behavior);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "pickup_behavior", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // dropoff_ingestor
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->dropoff_ingestor.data,
      strlen(ros_message->dropoff_ingestor.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "dropoff_ingestor", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // dropoff_behavior
    PyObject * field = NULL;
    field = rmf_task_msgs__msg__behavior__convert_to_py(&ros_message->dropoff_behavior);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "dropoff_behavior", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
