...
bool rmf_task_msgs__msg__station__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_task_msgs.msg._station.Station", full_classname_dest, 34) == 0);
  }
  rmf_task_msgs__msg__Station * ros_message = _ros_message;
  {  // task_id
  ...
  {  // place_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "place_name");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->place_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Station */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_task_msgs.msg._station");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Station");
  ...
  rmf_task_msgs__msg__Station * ros_message = (rmf_task_msgs__msg__Station *)raw_ros_message;
  {  // task_id
    PyObject * field = NULL;
  ...
  {  // place_name
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->place_name.data,
      strlen(ros_message->place_name.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "place_name", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
