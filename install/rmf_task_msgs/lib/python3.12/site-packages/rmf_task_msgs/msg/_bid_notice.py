...
class Metaclass_BidNotice(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'DRY_RUN__DEFAULT': False,
        }

    @property
    def DRY_RUN__DEFAULT(cls):
        """Return default value for message field 'dry_run'."""
        return False
...
class BidNotice(metaclass=Metaclass_BidNotice):
    ...
    def __init__(self, **kwargs):
        ...
        self.dry_run = kwargs.get(
            'dry_run', BidNotice.DRY_RUN__DEFAULT)
    ...
    def dry_run(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'dry_run' field must be of type 'bool'"
        self._dry_run = value
