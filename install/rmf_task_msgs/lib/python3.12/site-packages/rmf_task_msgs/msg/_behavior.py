...
class Metaclass_Behavior(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rmf_task_msgs.msg import BehaviorParameter
            if BehaviorParameter.__class__._TYPE_SUPPORT is None:
                BehaviorParameter.__class__.__import_type_support__()
...
class Behavior(metaclass=Metaclass_Behavior):
    ...
    _fields_and_field_types = {
        'name': 'string',
        'parameters': 'sequence<rmf_task_msgs/BehaviorParameter>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_task_msgs', 'msg'], 'BehaviorParameter')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, BehaviorParameter) for v in value) and
                 True), \
                "The 'parameters' field must be a set or sequence and each value of type 'BehaviorParameter'"
