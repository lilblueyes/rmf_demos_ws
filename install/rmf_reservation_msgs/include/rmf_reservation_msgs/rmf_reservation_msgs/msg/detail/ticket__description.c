...
static char rmf_reservation_msgs__msg__Ticket__FIELD_NAME__header[] = "header";
static char rmf_reservation_msgs__msg__Ticket__FIELD_NAME__ticket_id[] = "ticket_id";

static rosidl_runtime_c__type_description__Field rmf_reservation_msgs__msg__Ticket__FIELDS[] = {
  {
    {rmf_reservation_msgs__msg__Ticket__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {rmf_reservation_msgs__msg__Ticket__FIELD_NAME__ticket_id, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_reservation_msgs__msg__Ticket__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {rmf_reservation_msgs__msg__RequestHeader__TYPE_NAME, 38, 38},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_reservation_msgs__msg__Ticket__FIELDS, 2, 2},
    },
    {rmf_reservation_msgs__msg__Ticket__REFERENCED_TYPE_DESCRIPTIONS, 1, 1},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_reservation_msgs__msg__Ticket__get_individual_type_description_source(NULL),
