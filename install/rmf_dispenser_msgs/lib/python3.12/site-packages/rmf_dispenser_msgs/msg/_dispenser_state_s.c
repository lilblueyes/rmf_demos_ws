...
bool rmf_dispenser_msgs__msg__dispenser_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_dispenser_msgs.msg._dispenser_state.DispenserState", full_classname_dest, 54) == 0);
  }
  rmf_dispenser_msgs__msg__DispenserState * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of DispenserState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_dispenser_msgs.msg._dispenser_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DispenserState");
