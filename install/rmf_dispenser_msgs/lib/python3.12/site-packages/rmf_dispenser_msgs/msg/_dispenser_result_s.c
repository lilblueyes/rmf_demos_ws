...
bool rmf_dispenser_msgs__msg__dispenser_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_dispenser_msgs.msg._dispenser_result.DispenserResult", full_classname_dest, 56) == 0);
  }
  rmf_dispenser_msgs__msg__DispenserResult * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of DispenserResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_dispenser_msgs.msg._dispenser_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DispenserResult");
