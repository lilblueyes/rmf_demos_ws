...
bool rmf_dispenser_msgs__msg__dispenser_request_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_dispenser_msgs.msg._dispenser_request_item.DispenserRequestItem", full_classname_dest, 67) == 0);
  }
  rmf_dispenser_msgs__msg__DispenserRequestItem * ros_message = _ros_message;
  {  // type_guid
...
{
  /* NOTE(esteve): Call constructor of DispenserRequestItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_dispenser_msgs.msg._dispenser_request_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DispenserRequestItem");
