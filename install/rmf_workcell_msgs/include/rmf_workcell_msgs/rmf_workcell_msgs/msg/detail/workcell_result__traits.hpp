...
inline std::string to_yaml(const WorkcellResult & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rmf_workcell_msgs::msg::WorkcellResult & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rmf_workcell_msgs::msg::WorkcellResult & msg)
{
