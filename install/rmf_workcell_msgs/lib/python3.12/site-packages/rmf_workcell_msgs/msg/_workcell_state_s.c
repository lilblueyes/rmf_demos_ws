...
bool rmf_workcell_msgs__msg__workcell_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_workcell_msgs.msg._workcell_state.WorkcellState", full_classname_dest, 51) == 0);
  }
  rmf_workcell_msgs__msg__WorkcellState * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of WorkcellState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_workcell_msgs.msg._workcell_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorkcellState");
