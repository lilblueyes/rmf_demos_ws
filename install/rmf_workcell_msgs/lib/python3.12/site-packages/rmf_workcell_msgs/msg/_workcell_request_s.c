...
bool rmf_workcell_msgs__msg__workcell_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_workcell_msgs.msg._workcell_request.WorkcellRequest", full_classname_dest, 55) == 0);
  }
  rmf_workcell_msgs__msg__WorkcellRequest * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of WorkcellRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_workcell_msgs.msg._workcell_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorkcellRequest");
