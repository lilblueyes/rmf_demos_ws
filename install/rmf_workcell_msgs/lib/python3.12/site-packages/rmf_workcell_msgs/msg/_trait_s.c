...
bool rmf_workcell_msgs__msg__trait__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_workcell_msgs.msg._trait.Trait", full_classname_dest, 34) == 0);
  }
  rmf_workcell_msgs__msg__Trait * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of Trait */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_workcell_msgs.msg._trait");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Trait");
