...
bool rmf_ingestor_msgs__msg__ingestor_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_ingestor_msgs.msg._ingestor_result.IngestorResult", full_classname_dest, 53) == 0);
  }
  rmf_ingestor_msgs__msg__IngestorResult * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of IngestorResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_ingestor_msgs.msg._ingestor_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IngestorResult");
