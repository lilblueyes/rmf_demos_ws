...
inline std::string to_yaml(const IngestorState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rmf_ingestor_msgs::msg::IngestorState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rmf_ingestor_msgs::msg::IngestorState & msg)
{
