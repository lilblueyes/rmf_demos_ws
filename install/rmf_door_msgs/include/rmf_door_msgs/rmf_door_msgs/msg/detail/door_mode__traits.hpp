...
inline std::string to_yaml(const DoorMode & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rmf_door_msgs::msg::DoorMode & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rmf_door_msgs::msg::DoorMode & msg)
{
