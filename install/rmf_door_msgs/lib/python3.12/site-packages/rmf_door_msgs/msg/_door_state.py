...
class DoorState(metaclass=Metaclass_DoorState):
    ...
    _fields_and_field_types = {
        'door_time': 'builtin_interfaces/Time',
        'door_name': 'string',
        'current_mode': 'rmf_door_msgs/DoorMode',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from builtin_interfaces.msg import Time
        self.door_time = kwargs.get('door_time', Time())
        self.door_name = kwargs.get('door_name', str())
        from rmf_door_msgs.msg import DoorMode
        self.current_mode = kwargs.get('current_mode', DoorMode())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.door_time != other.door_time:
            return False
    ...
    def door_time(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'door_time' field must be a sub message of type 'Time'"
    ...
    def current_mode(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'current_mode' field must be a sub message of type 'DoorMode'"
