...
: ${AMENT_CURRENT_PREFIX:="/rmf_demos_ws/install/pybind11_json_vendor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pybind11_json_vendor/environment/vendor_package.sh"
