  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x14, 0xe1, 0xfe, 0xb5, 0x15, 0x99, 0xc8, 0xfc,
      0x89, 0x51, 0x6d, 0xf2, 0x95, 0x40, 0x5a, 0x96,
      0x86, 0x34, 0x09, 0x67, 0x31, 0x71, 0xbe, 0x27,
      0x51, 0x7c, 0xfe, 0xfe, 0x22, 0x95, 0xde, 0x4c,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t rmf_traffic_msgs__msg__NegotiationState__EXPECTED_HASH = {1, {
...
static char rmf_traffic_msgs__msg__NegotiationStates__TYPE_NAME[] = "rmf_traffic_msgs/msg/NegotiationStates";
...
static char rmf_traffic_msgs__msg__NegotiationStates__FIELD_NAME__negotiations[] = "negotiations";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__NegotiationStates__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__NegotiationStates__FIELD_NAME__negotiations, 12, 12},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__NegotiationStates__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rmf_traffic_msgs__msg__NegotiationStates__TYPE_NAME, 38, 38},
      {rmf_traffic_msgs__msg__NegotiationStates__FIELDS, 1, 1},
    },
    {rmf_traffic_msgs__msg__NegotiationStates__REFERENCED_TYPE_DESCRIPTIONS, 13, 13},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&rmf_traffic_msgs__msg__NegotiationState__EXPECTED_HASH, rmf_traffic_msgs__msg__NegotiationState__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[6].fields = rmf_traffic_msgs__msg__NegotiationState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[7].fields = rmf_traffic_msgs__msg__NegotiationStatus__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = rmf_traffic_msgs__msg__NegotiationTreeNode__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = rmf_traffic_msgs__msg__Route__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__NegotiationStates__get_individual_type_description_source(NULL),
    ...
    sources[7] = *rmf_traffic_msgs__msg__NegotiationState__get_individual_type_description_source(NULL);
    sources[8] = *rmf_traffic_msgs__msg__NegotiationStatus__get_individual_type_description_source(NULL);
    sources[9] = *rmf_traffic_msgs__msg__NegotiationTreeNode__get_individual_type_description_source(NULL);
    sources[10] = *rmf_traffic_msgs__msg__Route__get_individual_type_description_source(NULL);
