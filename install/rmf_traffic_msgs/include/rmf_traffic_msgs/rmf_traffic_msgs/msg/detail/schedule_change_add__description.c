...
static char rmf_traffic_msgs__msg__ScheduleChangeAdd__FIELD_NAME__plan_id[] = "plan_id";
static char rmf_traffic_msgs__msg__ScheduleChangeAdd__FIELD_NAME__items[] = "items";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__ScheduleChangeAdd__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__ScheduleChangeAdd__FIELD_NAME__plan_id, 7, 7},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleChangeAdd__FIELD_NAME__items, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__ScheduleChangeAdd__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__ScheduleChangeAdd__FIELDS, 2, 2},
    },
    {rmf_traffic_msgs__msg__ScheduleChangeAdd__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = rmf_traffic_msgs__msg__ScheduleChangeAddItem__get_type_description(NULL)->type_description.fields;
...
rmf_traffic_msgs__msg__ScheduleChangeAdd__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__ScheduleChangeAdd__get_individual_type_description_source(NULL),
    sources[1] = *rmf_traffic_msgs__msg__Route__get_individual_type_description_source(NULL);
    sources[2] = *rmf_traffic_msgs__msg__ScheduleChangeAddItem__get_individual_type_description_source(NULL);
