...
void fetch_function__NegotiationAck__acknowledgments(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rmf_traffic_msgs::msg::NegotiationParticipantAck *>(
    get_const_function__NegotiationAck__acknowledgments(untyped_member, index));
  auto & value = *reinterpret_cast<rmf_traffic_msgs::msg::NegotiationParticipantAck *>(untyped_value);
  value = item;
}

void assign_function__NegotiationAck__acknowledgments(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rmf_traffic_msgs::msg::NegotiationParticipantAck *>(
    get_function__NegotiationAck__acknowledgments(untyped_member, index));
  const auto & value = *reinterpret_cast<const rmf_traffic_msgs::msg::NegotiationParticipantAck *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NegotiationAck_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__NegotiationAck__acknowledgments,  // fetch(index, &value) function pointer
    assign_function__NegotiationAck__acknowledgments,  // assign(index, value) function pointer
