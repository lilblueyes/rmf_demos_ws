...
static char rmf_traffic_msgs__msg__ScheduleQuery__FIELD_NAME__spacetime[] = "spacetime";
static char rmf_traffic_msgs__msg__ScheduleQuery__FIELD_NAME__participants[] = "participants";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__ScheduleQuery__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__ScheduleQuery__FIELD_NAME__spacetime, 9, 9},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleQuery__FIELD_NAME__participants, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__ScheduleQuery__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__ScheduleQuery__FIELDS, 2, 2},
    },
    {rmf_traffic_msgs__msg__ScheduleQuery__REFERENCED_TYPE_DESCRIPTIONS, 10, 10},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[4].fields = rmf_traffic_msgs__msg__ScheduleQueryParticipants__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = rmf_traffic_msgs__msg__ScheduleQuerySpacetime__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = rmf_traffic_msgs__msg__Shape__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[7].fields = rmf_traffic_msgs__msg__ShapeContext__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = rmf_traffic_msgs__msg__Space__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = rmf_traffic_msgs__msg__Timespan__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  "\n"
  "ScheduleQuerySpacetime spacetime\n"
  "\n"
  "ScheduleQueryParticipants participants";
...
rmf_traffic_msgs__msg__ScheduleQuery__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__ScheduleQuery__get_individual_type_description_source(NULL),
    ...
    sources[5] = *rmf_traffic_msgs__msg__ScheduleQueryParticipants__get_individual_type_description_source(NULL);
    sources[6] = *rmf_traffic_msgs__msg__ScheduleQuerySpacetime__get_individual_type_description_source(NULL);
    sources[7] = *rmf_traffic_msgs__msg__Shape__get_individual_type_description_source(NULL);
    sources[8] = *rmf_traffic_msgs__msg__ShapeContext__get_individual_type_description_source(NULL);
    sources[9] = *rmf_traffic_msgs__msg__Space__get_individual_type_description_source(NULL);
    sources[10] = *rmf_traffic_msgs__msg__Timespan__get_individual_type_description_source(NULL);
    constructed = true;
  }
