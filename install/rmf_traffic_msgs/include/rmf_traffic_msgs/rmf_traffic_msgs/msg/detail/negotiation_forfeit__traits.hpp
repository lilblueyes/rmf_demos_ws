...
inline std::string to_yaml(const NegotiationForfeit & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rmf_traffic_msgs::msg::NegotiationForfeit & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rmf_traffic_msgs::msg::NegotiationForfeit & msg)
{
