...
static char rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__name[] = "name";
static char rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__owner[] = "owner";
static char rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__responsiveness[] = "responsiveness";
static char rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__profile[] = "profile";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__ParticipantDescription__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__owner, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__responsiveness, 14, 14},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ParticipantDescription__FIELD_NAME__profile, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__ParticipantDescription__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__ParticipantDescription__FIELDS, 4, 4},
    },
    {rmf_traffic_msgs__msg__ParticipantDescription__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = rmf_traffic_msgs__msg__Profile__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
rmf_traffic_msgs__msg__ParticipantDescription__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__ParticipantDescription__get_individual_type_description_source(NULL),
    ...
    sources[4] = *rmf_traffic_msgs__msg__Profile__get_individual_type_description_source(NULL);
    constructed = true;
  }
