...
static char rmf_traffic_msgs__msg__Itinerary__FIELD_NAME__routes[] = "routes";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__Itinerary__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__Itinerary__FIELD_NAME__routes, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__Itinerary__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {rmf_traffic_msgs__msg__Route__TYPE_NAME, 26, 26},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__Itinerary__FIELDS, 1, 1},
    },
    {rmf_traffic_msgs__msg__Itinerary__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
rmf_traffic_msgs__msg__Itinerary__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__Itinerary__get_individual_type_description_source(NULL),
