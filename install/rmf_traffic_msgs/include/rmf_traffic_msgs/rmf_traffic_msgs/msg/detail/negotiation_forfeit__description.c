...
static char rmf_traffic_msgs__msg__NegotiationForfeit__FIELD_NAME__conflict_version[] = "conflict_version";
static char rmf_traffic_msgs__msg__NegotiationForfeit__FIELD_NAME__table[] = "table";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__NegotiationForfeit__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__NegotiationForfeit__FIELD_NAME__conflict_version, 16, 16},
    {
  ...
  {
    {rmf_traffic_msgs__msg__NegotiationForfeit__FIELD_NAME__table, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__NegotiationForfeit__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {rmf_traffic_msgs__msg__NegotiationKey__TYPE_NAME, 35, 35},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__NegotiationForfeit__FIELDS, 2, 2},
    },
    {rmf_traffic_msgs__msg__NegotiationForfeit__REFERENCED_TYPE_DESCRIPTIONS, 1, 1},
  };
  if (!constructed) {
...
rmf_traffic_msgs__msg__NegotiationForfeit__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__NegotiationForfeit__get_individual_type_description_source(NULL),
