...
static char rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__participant_id[] = "participant_id";
static char rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__itinerary_version[] = "itinerary_version";
static char rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__erasures[] = "erasures";
static char rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__delays[] = "delays";
static char rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__additions[] = "additions";
static char rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__progress[] = "progress";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__participant_id, 14, 14},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__itinerary_version, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT64,
      0,
      0,
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__erasures, 8, 8},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__delays, 6, 6},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__additions, 9, 9},
    {
  ...
  {
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELD_NAME__progress, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__ScheduleParticipantPatch__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__ScheduleParticipantPatch__FIELDS, 6, 6},
    },
    {rmf_traffic_msgs__msg__ScheduleParticipantPatch__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = rmf_traffic_msgs__msg__ScheduleChangeDelay__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[4].fields = rmf_traffic_msgs__msg__ScheduleChangeProgress__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = rmf_traffic_msgs__msg__TrafficDependency__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = rmf_traffic_msgs__msg__Trajectory__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[7].fields = rmf_traffic_msgs__msg__TrajectoryWaypoint__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "uint64[] erasures\n"
  "\n"
  "ScheduleChangeDelay[] delays\n"
  "\n"
  "ScheduleChangeAdd additions\n"
  "\n"
  "ScheduleChangeProgress progress";
...
rmf_traffic_msgs__msg__ScheduleParticipantPatch__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__ScheduleParticipantPatch__get_individual_type_description_source(NULL),
    ...
    sources[4] = *rmf_traffic_msgs__msg__ScheduleChangeDelay__get_individual_type_description_source(NULL);
    sources[5] = *rmf_traffic_msgs__msg__ScheduleChangeProgress__get_individual_type_description_source(NULL);
    sources[6] = *rmf_traffic_msgs__msg__TrafficDependency__get_individual_type_description_source(NULL);
    sources[7] = *rmf_traffic_msgs__msg__Trajectory__get_individual_type_description_source(NULL);
    sources[8] = *rmf_traffic_msgs__msg__TrajectoryWaypoint__get_individual_type_description_source(NULL);
    constructed = true;
  }
