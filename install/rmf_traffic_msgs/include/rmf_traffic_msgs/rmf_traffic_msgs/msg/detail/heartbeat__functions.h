...
#ifndef RMF_TRAFFIC_MSGS__MSG__DETAIL__HEARTBEAT__FUNCTIONS_H_
#define RMF_TRAFFIC_MSGS__MSG__DETAIL__HEARTBEAT__FUNCTIONS_H_
 ...
 * )) before or use
 * rmf_traffic_msgs__msg__Heartbeat__create()
 ...
 * calls
 * rmf_traffic_msgs__msg__Heartbeat__init().
...
/**
 * It calls
 * rmf_traffic_msgs__msg__Heartbeat__fini()
 ...
 * rmf_traffic_msgs__msg__Heartbeat__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rmf_traffic_msgs__msg__Heartbeat__Sequence__fini()
 * on the array,
...
#endif  // RMF_TRAFFIC_MSGS__MSG__DETAIL__HEARTBEAT__FUNCTIONS_H_
