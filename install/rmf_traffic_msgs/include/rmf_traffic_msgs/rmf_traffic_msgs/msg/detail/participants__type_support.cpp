...
void fetch_function__Participants__participants(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rmf_traffic_msgs::msg::Participant *>(
    get_const_function__Participants__participants(untyped_member, index));
  auto & value = *reinterpret_cast<rmf_traffic_msgs::msg::Participant *>(untyped_value);
  value = item;
}

void assign_function__Participants__participants(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rmf_traffic_msgs::msg::Participant *>(
    get_function__Participants__participants(untyped_member, index));
  const auto & value = *reinterpret_cast<const rmf_traffic_msgs::msg::Participant *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Participants_message_member_array[2] = {
  {
    "node_id",  // name
    ...
    offsetof(rmf_traffic_msgs::msg::Participants, node_id),  // bytes offset in struct
  ...
  },
  {
    ...
    fetch_function__Participants__participants,  // fetch(index, &value) function pointer
    assign_function__Participants__participants,  // assign(index, value) function pointer
