...
static char rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__parent[] = "parent";
static char rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__key[] = "key";
static char rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__rejected[] = "rejected";
static char rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__itinerary[] = "itinerary";

static rosidl_runtime_c__type_description__Field rmf_traffic_msgs__msg__NegotiationTreeNode__FIELDS[] = {
  {
    {rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__parent, 6, 6},
    {
  ...
  {
    {rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__key, 3, 3},
    {
  ...
  {
    {rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__rejected, 8, 8},
    {
  ...
  {
    {rmf_traffic_msgs__msg__NegotiationTreeNode__FIELD_NAME__itinerary, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_traffic_msgs__msg__NegotiationTreeNode__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {rmf_traffic_msgs__msg__NegotiationKey__TYPE_NAME, 35, 35},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_traffic_msgs__msg__NegotiationTreeNode__FIELDS, 4, 4},
    },
    {rmf_traffic_msgs__msg__NegotiationTreeNode__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_traffic_msgs__msg__NegotiationTreeNode__get_individual_type_description_source(NULL),
