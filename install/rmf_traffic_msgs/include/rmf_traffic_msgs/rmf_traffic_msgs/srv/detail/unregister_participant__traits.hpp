...
inline void to_flow_style_yaml(
  const UnregisterParticipant_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const UnregisterParticipant_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rmf_traffic_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rmf_traffic_msgs::srv::UnregisterParticipant_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rmf_traffic_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rmf_traffic_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rmf_traffic_msgs::srv::UnregisterParticipant_Event & msg)
{
  return rmf_traffic_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rmf_traffic_msgs::srv::UnregisterParticipant_Event>()
{
  return "rmf_traffic_msgs::srv::UnregisterParticipant_Event";
}

template<>
inline const char * name<rmf_traffic_msgs::srv::UnregisterParticipant_Event>()
{
  return "rmf_traffic_msgs/srv/UnregisterParticipant_Event";
}

template<>
struct has_fixed_size<rmf_traffic_msgs::srv::UnregisterParticipant_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rmf_traffic_msgs::srv::UnregisterParticipant_Event>
  : std::integral_constant<bool, has_bounded_size<rmf_traffic_msgs::srv::UnregisterParticipant_Request>::value && has_bounded_size<rmf_traffic_msgs::srv::UnregisterParticipant_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rmf_traffic_msgs::srv::UnregisterParticipant_Event>
  : std::true_type {};
