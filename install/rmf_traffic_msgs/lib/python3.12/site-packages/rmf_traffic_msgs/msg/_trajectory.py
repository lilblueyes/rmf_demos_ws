...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rmf_traffic_msgs.msg import TrajectoryWaypoint
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<rmf_traffic_msgs/TrajectoryWaypoint>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_traffic_msgs', 'msg'], 'TrajectoryWaypoint')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'waypoints' field must be a set or sequence and each value of type 'TrajectoryWaypoint'"
