...
bool rmf_traffic_msgs__msg__negotiation_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._negotiation_status.NegotiationStatus", full_classname_dest, 58) == 0);
  }
  rmf_traffic_msgs__msg__NegotiationStatus * ros_message = _ros_message;
  {  // conflict_version
  ...
  {  // participants
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint64_t * dest = ros_message->participants.data;
  ...
  {  // last_response_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "last_response_time");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->last_response_time)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of NegotiationStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._negotiation_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NegotiationStatus");
  ...
  rmf_traffic_msgs__msg__NegotiationStatus * ros_message = (rmf_traffic_msgs__msg__NegotiationStatus *)raw_ros_message;
  {  // conflict_version
    PyObject * field = NULL;
  ...
  {  // participants
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "participants");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->participants.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint64_t * src = &(ros_message->participants.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->participants.size * sizeof(uint64_t));
      assert(data != NULL);
  ...
  {  // last_response_time
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->last_response_time);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "last_response_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
