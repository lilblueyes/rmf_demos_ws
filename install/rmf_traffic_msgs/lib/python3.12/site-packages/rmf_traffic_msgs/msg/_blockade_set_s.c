...
bool rmf_traffic_msgs__msg__blockade_set__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._blockade_set.BlockadeSet", full_classname_dest, 46) == 0);
  }
  rmf_traffic_msgs__msg__BlockadeSet * ros_message = _ros_message;
  {  // participant
  ...
  {  // path
    ...
    if (!rmf_traffic_msgs__msg__BlockadeCheckpoint__Sequence__init(&(ros_message->path), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rmf_traffic_msgs__msg__BlockadeCheckpoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rmf_traffic_msgs__msg__BlockadeCheckpoint * dest = ros_message->path.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rmf_traffic_msgs__msg__blockade_checkpoint__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmf_traffic_msgs__msg__blockade_set__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BlockadeSet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._blockade_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BlockadeSet");
  ...
  rmf_traffic_msgs__msg__BlockadeSet * ros_message = (rmf_traffic_msgs__msg__BlockadeSet *)raw_ros_message;
  {  // participant
    PyObject * field = NULL;
  ...
  {  // path
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rmf_traffic_msgs__msg__blockade_checkpoint__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
