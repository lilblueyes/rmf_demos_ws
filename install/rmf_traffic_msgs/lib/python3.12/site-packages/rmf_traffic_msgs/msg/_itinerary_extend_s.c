...
bool rmf_traffic_msgs__msg__itinerary_extend__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._itinerary_extend.ItineraryExtend", full_classname_dest, 54) == 0);
  }
  rmf_traffic_msgs__msg__ItineraryExtend * ros_message = _ros_message;
  {  // participant
  ...
  {  // routes
    ...
    rmf_traffic_msgs__msg__Route * dest = ros_message->routes.data;
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmf_traffic_msgs__msg__itinerary_extend__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ItineraryExtend */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._itinerary_extend");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ItineraryExtend");
  ...
  rmf_traffic_msgs__msg__ItineraryExtend * ros_message = (rmf_traffic_msgs__msg__ItineraryExtend *)raw_ros_message;
  {  // participant
    PyObject * field = NULL;
