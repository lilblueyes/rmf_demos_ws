...
class Metaclass_NegotiationConclusion(type):
    """Metaclass of message 'NegotiationConclusion'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rmf_traffic_msgs.msg.NegotiationConclusion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__negotiation_conclusion
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__negotiation_conclusion
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__negotiation_conclusion
            cls._TYPE_SUPPORT = module.type_support_msg__msg__negotiation_conclusion
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__negotiation_conclusion
...
class NegotiationConclusion(metaclass=Metaclass_NegotiationConclusion):
    """Message class 'NegotiationConclusion'."""
