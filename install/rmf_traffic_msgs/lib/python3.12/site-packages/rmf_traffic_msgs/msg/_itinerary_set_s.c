...
bool rmf_traffic_msgs__msg__itinerary_set__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._itinerary_set.ItinerarySet", full_classname_dest, 48) == 0);
  }
  rmf_traffic_msgs__msg__ItinerarySet * ros_message = _ros_message;
  {  // participant
  ...
  {  // storage_base
    PyObject * field = PyObject_GetAttrString(_pymsg, "storage_base");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->storage_base = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // itinerary_version
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmf_traffic_msgs__msg__itinerary_set__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ItinerarySet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._itinerary_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ItinerarySet");
  ...
  rmf_traffic_msgs__msg__ItinerarySet * ros_message = (rmf_traffic_msgs__msg__ItinerarySet *)raw_ros_message;
  {  // participant
    PyObject * field = NULL;
  ...
  {  // storage_base
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->storage_base);
    {
      int rc = PyObject_SetAttrString(_pymessage, "storage_base", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
