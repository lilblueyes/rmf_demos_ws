...
bool rmf_traffic_msgs__msg__negotiation_conclusion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._negotiation_conclusion.NegotiationConclusion", full_classname_dest, 66) == 0);
  }
  rmf_traffic_msgs__msg__NegotiationConclusion * ros_message = _ros_message;
  {  // conflict_version
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmf_traffic_msgs__msg__negotiation_conclusion__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of NegotiationConclusion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._negotiation_conclusion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NegotiationConclusion");
  ...
  rmf_traffic_msgs__msg__NegotiationConclusion * ros_message = (rmf_traffic_msgs__msg__NegotiationConclusion *)raw_ros_message;
  {  // conflict_version
    PyObject * field = NULL;
