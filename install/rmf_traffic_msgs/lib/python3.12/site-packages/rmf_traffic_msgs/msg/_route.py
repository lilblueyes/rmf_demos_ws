...
class Metaclass_Route(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rmf_traffic_msgs.msg import TrafficDependency
            if TrafficDependency.__class__._TYPE_SUPPORT is None:
                TrafficDependency.__class__.__import_type_support__()

            from rmf_traffic_msgs.msg import Trajectory
...
class Route(metaclass=Metaclass_Route):
    ...
    _fields_and_field_types = {
        'map': 'string',
        'trajectory': 'rmf_traffic_msgs/Trajectory',
        'checkpoints': 'sequence<uint64>',
        'dependencies': 'sequence<rmf_traffic_msgs/TrafficDependency>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['rmf_traffic_msgs', 'msg'], 'Trajectory'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('uint64')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_traffic_msgs', 'msg'], 'TrafficDependency')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, TrafficDependency) for v in value) and
                 True), \
                "The 'dependencies' field must be a set or sequence and each value of type 'TrafficDependency'"
