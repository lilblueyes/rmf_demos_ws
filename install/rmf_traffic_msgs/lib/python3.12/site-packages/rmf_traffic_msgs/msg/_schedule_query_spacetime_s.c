...
bool rmf_traffic_msgs__msg__schedule_query_spacetime__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._schedule_query_spacetime.ScheduleQuerySpacetime", full_classname_dest, 69) == 0);
  }
  rmf_traffic_msgs__msg__ScheduleQuerySpacetime * ros_message = _ros_message;
  {  // type
  ...
  {  // regions
    ...
    if (!rmf_traffic_msgs__msg__Region__Sequence__init(&(ros_message->regions), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rmf_traffic_msgs__msg__Region__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rmf_traffic_msgs__msg__Region * dest = ros_message->regions.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rmf_traffic_msgs__msg__region__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // shape_context
    ...
    if (!rmf_traffic_msgs__msg__shape_context__convert_from_py(field, &ros_message->shape_context)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ScheduleQuerySpacetime */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._schedule_query_spacetime");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScheduleQuerySpacetime");
  ...
  rmf_traffic_msgs__msg__ScheduleQuerySpacetime * ros_message = (rmf_traffic_msgs__msg__ScheduleQuerySpacetime *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
  ...
  {  // regions
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rmf_traffic_msgs__msg__region__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // shape_context
    PyObject * field = NULL;
    field = rmf_traffic_msgs__msg__shape_context__convert_to_py(&ros_message->shape_context);
    if (!field) {
      return NULL;
    }
    {
