...
class Metaclass_NegotiationParticipantAck(type):
    """Metaclass of message 'NegotiationParticipantAck'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__negotiation_participant_ack
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__negotiation_participant_ack
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__negotiation_participant_ack
            cls._TYPE_SUPPORT = module.type_support_msg__msg__negotiation_participant_ack
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__negotiation_participant_ack
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'UPDATING__DEFAULT': False,
        }

    @property
    def UPDATING__DEFAULT(cls):
        """Return default value for message field 'updating'."""
        return False


class NegotiationParticipantAck(metaclass=Metaclass_NegotiationParticipantAck):
    """Message class 'NegotiationParticipantAck'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.updating = kwargs.get(
            'updating', NegotiationParticipantAck.UPDATING__DEFAULT)
    ...
    def updating(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'updating' field must be of type 'bool'"
