...
bool rmf_traffic_msgs__msg__shape__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._shape.Shape", full_classname_dest, 33) == 0);
  }
  rmf_traffic_msgs__msg__Shape * ros_message = _ros_message;
  {  // type
...
PyObject * rmf_traffic_msgs__msg__shape__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._shape");
  ...
  rmf_traffic_msgs__msg__Shape * ros_message = (rmf_traffic_msgs__msg__Shape *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
