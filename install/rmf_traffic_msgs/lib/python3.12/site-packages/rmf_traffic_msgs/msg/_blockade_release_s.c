...
bool rmf_traffic_msgs__msg__blockade_release__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._blockade_release.BlockadeRelease", full_classname_dest, 54) == 0);
  }
  rmf_traffic_msgs__msg__BlockadeRelease * ros_message = _ros_message;
  {  // participant
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmf_traffic_msgs__msg__blockade_release__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BlockadeRelease */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._blockade_release");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BlockadeRelease");
  ...
  rmf_traffic_msgs__msg__BlockadeRelease * ros_message = (rmf_traffic_msgs__msg__BlockadeRelease *)raw_ros_message;
  {  // participant
    PyObject * field = NULL;
