...
bool rmf_traffic_msgs__msg__trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * rmf_traffic_msgs__msg__trajectory__convert_to_py(void * raw_ros_message);
...
bool rmf_traffic_msgs__msg__route__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._route.Route", full_classname_dest, 33) == 0);
  }
  rmf_traffic_msgs__msg__Route * ros_message = _ros_message;
  {  // map
  ...
  {  // trajectory
    ...
    if (!rmf_traffic_msgs__msg__trajectory__convert_from_py(field, &ros_message->trajectory)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // checkpoints
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint64_t * dest = ros_message->checkpoints.data;
  ...
  {  // dependencies
    ...
    if (!rmf_traffic_msgs__msg__TrafficDependency__Sequence__init(&(ros_message->dependencies), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rmf_traffic_msgs__msg__TrafficDependency__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rmf_traffic_msgs__msg__TrafficDependency * dest = ros_message->dependencies.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rmf_traffic_msgs__msg__traffic_dependency__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * rmf_traffic_msgs__msg__route__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._route");
  ...
  rmf_traffic_msgs__msg__Route * ros_message = (rmf_traffic_msgs__msg__Route *)raw_ros_message;
  {  // map
    PyObject * field = NULL;
  ...
  {  // trajectory
    PyObject * field = NULL;
    field = rmf_traffic_msgs__msg__trajectory__convert_to_py(&ros_message->trajectory);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // checkpoints
    ...
    if (ros_message->checkpoints.size > 0) {
      ...
      uint64_t * src = &(ros_message->checkpoints.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->checkpoints.size * sizeof(uint64_t));
      assert(data != NULL);
  ...
  {  // dependencies
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rmf_traffic_msgs__msg__traffic_dependency__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
