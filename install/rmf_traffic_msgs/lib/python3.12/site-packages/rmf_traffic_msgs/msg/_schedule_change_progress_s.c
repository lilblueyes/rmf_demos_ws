...
bool rmf_traffic_msgs__msg__schedule_change_progress__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._schedule_change_progress.ScheduleChangeProgress", full_classname_dest, 69) == 0);
  }
  rmf_traffic_msgs__msg__ScheduleChangeProgress * ros_message = _ros_message;
  {  // has_progress
    PyObject * field = PyObject_GetAttrString(_pymsg, "has_progress");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->has_progress = (Py_True == field);
    Py_DECREF(field);
  }
  {  // version
...
{
  /* NOTE(esteve): Call constructor of ScheduleChangeProgress */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._schedule_change_progress");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScheduleChangeProgress");
  ...
  rmf_traffic_msgs__msg__ScheduleChangeProgress * ros_message = (rmf_traffic_msgs__msg__ScheduleChangeProgress *)raw_ros_message;
  {  // has_progress
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->has_progress ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "has_progress", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
