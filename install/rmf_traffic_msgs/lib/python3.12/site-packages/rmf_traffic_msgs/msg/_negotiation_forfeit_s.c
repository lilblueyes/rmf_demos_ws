...
bool rmf_traffic_msgs__msg__negotiation_forfeit__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._negotiation_forfeit.NegotiationForfeit", full_classname_dest, 60) == 0);
  }
  rmf_traffic_msgs__msg__NegotiationForfeit * ros_message = _ros_message;
  {  // conflict_version
...
{
  /* NOTE(esteve): Call constructor of NegotiationForfeit */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._negotiation_forfeit");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NegotiationForfeit");
  ...
  rmf_traffic_msgs__msg__NegotiationForfeit * ros_message = (rmf_traffic_msgs__msg__NegotiationForfeit *)raw_ros_message;
  {  // conflict_version
    PyObject * field = NULL;
