...
bool rmf_traffic_msgs__msg__schedule_query_participants__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._schedule_query_participants.ScheduleQueryParticipants", full_classname_dest, 75) == 0);
  }
  rmf_traffic_msgs__msg__ScheduleQueryParticipants * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of ScheduleQueryParticipants */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._schedule_query_participants");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScheduleQueryParticipants");
  ...
  rmf_traffic_msgs__msg__ScheduleQueryParticipants * ros_message = (rmf_traffic_msgs__msg__ScheduleQueryParticipants *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
