...
bool rmf_traffic_msgs__msg__blockade_ready__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._blockade_ready.BlockadeReady", full_classname_dest, 50) == 0);
  }
  rmf_traffic_msgs__msg__BlockadeReady * ros_message = _ros_message;
  {  // participant
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmf_traffic_msgs__msg__blockade_ready__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BlockadeReady */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._blockade_ready");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BlockadeReady");
  ...
  rmf_traffic_msgs__msg__BlockadeReady * ros_message = (rmf_traffic_msgs__msg__BlockadeReady *)raw_ros_message;
  {  // participant
    PyObject * field = NULL;
