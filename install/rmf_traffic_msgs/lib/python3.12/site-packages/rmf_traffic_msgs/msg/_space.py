...
class Metaclass_Space(type):
    """Metaclass of message 'Space'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__space
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__space
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__space
            cls._TYPE_SUPPORT = module.type_support_msg__msg__space
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__space

            from geometry_msgs.msg import Pose2D
            if Pose2D.__class__._TYPE_SUPPORT is None:
                Pose2D.__class__.__import_type_support__()

            from rmf_traffic_msgs.msg import Shape
...
class Space(metaclass=Metaclass_Space):
    """Message class 'Space'."""
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['rmf_traffic_msgs', 'msg'], 'Shape'),  # noqa: E501
