...
bool rmf_traffic_msgs__msg__circle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._circle.Circle", full_classname_dest, 35) == 0);
  }
  rmf_traffic_msgs__msg__Circle * ros_message = _ros_message;
  {  // radius
...
PyObject * rmf_traffic_msgs__msg__circle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._circle");
  ...
  rmf_traffic_msgs__msg__Circle * ros_message = (rmf_traffic_msgs__msg__Circle *)raw_ros_message;
  {  // radius
    PyObject * field = NULL;
