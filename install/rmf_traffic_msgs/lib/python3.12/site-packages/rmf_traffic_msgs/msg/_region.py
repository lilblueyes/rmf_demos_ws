...
class Metaclass_Region(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rmf_traffic_msgs.msg import Space
            if Space.__class__._TYPE_SUPPORT is None:
                Space.__class__.__import_type_support__()
...
class Region(metaclass=Metaclass_Region):
    ...
    _fields_and_field_types = {
        'map': 'string',
        'spaces': 'sequence<rmf_traffic_msgs/Space>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_traffic_msgs', 'msg'], 'Space')),  # noqa: E501
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Space) for v in value) and
                 True), \
                "The 'spaces' field must be a set or sequence and each value of type 'Space'"
        self._spaces = value
