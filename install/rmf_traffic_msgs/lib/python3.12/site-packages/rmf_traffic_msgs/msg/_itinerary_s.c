...
bool rmf_traffic_msgs__msg__itinerary__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_traffic_msgs.msg._itinerary.Itinerary", full_classname_dest, 41) == 0);
  }
  rmf_traffic_msgs__msg__Itinerary * ros_message = _ros_message;
  {  // routes
...
{
  /* NOTE(esteve): Call constructor of Itinerary */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_traffic_msgs.msg._itinerary");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Itinerary");
  ...
  rmf_traffic_msgs__msg__Itinerary * ros_message = (rmf_traffic_msgs__msg__Itinerary *)raw_ros_message;
  {  // routes
    PyObject * field = NULL;
