...
class Graph(metaclass=Metaclass_Graph):
    ...
    _fields_and_field_types = {
        'name': 'string',
        'vertices': 'sequence<rmf_building_map_msgs/GraphNode>',
        'edges': 'sequence<rmf_building_map_msgs/GraphEdge>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_building_map_msgs', 'msg'], 'GraphNode')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_building_map_msgs', 'msg'], 'GraphEdge')),  # noqa: E501
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'vertices' field must be a set or sequence and each value of type 'GraphNode'"
