...
bool rmf_building_map_msgs__msg__graph_edge__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_building_map_msgs.msg._graph_edge.GraphEdge", full_classname_dest, 47) == 0);
  }
  rmf_building_map_msgs__msg__GraphEdge * ros_message = _ros_message;
  {  // v1_idx
    PyObject * field = PyObject_GetAttrString(_pymsg, "v1_idx");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->v1_idx = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // v2_idx
    PyObject * field = PyObject_GetAttrString(_pymsg, "v2_idx");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->v2_idx = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // params
...
PyObject * rmf_building_map_msgs__msg__graph_edge__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_building_map_msgs.msg._graph_edge");
  ...
  rmf_building_map_msgs__msg__GraphEdge * ros_message = (rmf_building_map_msgs__msg__GraphEdge *)raw_ros_message;
  {  // v1_idx
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->v1_idx);
    {
      int rc = PyObject_SetAttrString(_pymessage, "v1_idx", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // v2_idx
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->v2_idx);
    {
      int rc = PyObject_SetAttrString(_pymessage, "v2_idx", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
