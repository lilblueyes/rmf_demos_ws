...
bool rmf_building_map_msgs__msg__graph_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_building_map_msgs.msg._graph_node.GraphNode", full_classname_dest, 47) == 0);
  }
  rmf_building_map_msgs__msg__GraphNode * ros_message = _ros_message;
  {  // x
...
PyObject * rmf_building_map_msgs__msg__graph_node__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_building_map_msgs.msg._graph_node");
  ...
  rmf_building_map_msgs__msg__GraphNode * ros_message = (rmf_building_map_msgs__msg__GraphNode *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
