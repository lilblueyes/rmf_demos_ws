...
bool rmf_building_map_msgs__msg__affine_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_building_map_msgs.msg._affine_image.AffineImage", full_classname_dest, 51) == 0);
  }
  rmf_building_map_msgs__msg__AffineImage * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of AffineImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_building_map_msgs.msg._affine_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AffineImage");
  ...
  rmf_building_map_msgs__msg__AffineImage * ros_message = (rmf_building_map_msgs__msg__AffineImage *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
