...
bool rmf_building_map_msgs__msg__place__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_building_map_msgs.msg._place.Place", full_classname_dest, 38) == 0);
  }
  rmf_building_map_msgs__msg__Place * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of Place */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_building_map_msgs.msg._place");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Place");
  ...
  rmf_building_map_msgs__msg__Place * ros_message = (rmf_building_map_msgs__msg__Place *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
