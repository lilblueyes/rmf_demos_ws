...
class Metaclass_GetBuildingMap_Event(type):
    """Metaclass of message 'GetBuildingMap_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_building_map__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_building_map__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_building_map__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_building_map__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_building_map__event
...
class GetBuildingMap_Event(metaclass=Metaclass_GetBuildingMap_Event):
    """Message class 'GetBuildingMap_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rmf_building_map_msgs/GetBuildingMap_Request, 1>',
        'response': 'sequence<rmf_building_map_msgs/GetBuildingMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rmf_building_map_msgs', 'srv'], 'GetBuildingMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rmf_building_map_msgs', 'srv'], 'GetBuildingMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rmf_building_map_msgs.srv import GetBuildingMap_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetBuildingMap_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetBuildingMap_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rmf_building_map_msgs.srv import GetBuildingMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetBuildingMap_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetBuildingMap_Response'"
...
class Metaclass_GetBuildingMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_building_map.Metaclass_GetBuildingMap_Event._TYPE_SUPPORT is None:
                _get_building_map.Metaclass_GetBuildingMap_Event.__import_type_support__()
...
class GetBuildingMap(metaclass=Metaclass_GetBuildingMap):
    ...
    from rmf_building_map_msgs.srv._get_building_map import GetBuildingMap_Event as Event
