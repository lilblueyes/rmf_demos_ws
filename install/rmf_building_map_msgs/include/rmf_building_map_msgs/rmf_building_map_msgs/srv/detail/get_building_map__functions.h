...
/// Check for srv/GetBuildingMap message equality.
/**
...
/// Copy a srv/GetBuildingMap message.
/**
...
/// Check for srv/GetBuildingMap message array equality.
/**
...
/// Copy an array of srv/GetBuildingMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * rmf_building_map_msgs__srv__GetBuildingMap_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
...
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
...
/**
 * It allocates the memory for the array and calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_building_map_msgs
...
/**
 * It calls
 * rmf_building_map_msgs__srv__GetBuildingMap_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
