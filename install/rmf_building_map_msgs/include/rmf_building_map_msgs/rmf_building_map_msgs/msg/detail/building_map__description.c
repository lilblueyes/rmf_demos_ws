...
static char rmf_building_map_msgs__msg__BuildingMap__FIELD_NAME__name[] = "name";
static char rmf_building_map_msgs__msg__BuildingMap__FIELD_NAME__levels[] = "levels";
static char rmf_building_map_msgs__msg__BuildingMap__FIELD_NAME__lifts[] = "lifts";

static rosidl_runtime_c__type_description__Field rmf_building_map_msgs__msg__BuildingMap__FIELDS[] = {
  {
    {rmf_building_map_msgs__msg__BuildingMap__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {rmf_building_map_msgs__msg__BuildingMap__FIELD_NAME__levels, 6, 6},
    {
  ...
  {
    {rmf_building_map_msgs__msg__BuildingMap__FIELD_NAME__lifts, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_building_map_msgs__msg__BuildingMap__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rmf_building_map_msgs__msg__BuildingMap__FIELDS, 3, 3},
    },
    {rmf_building_map_msgs__msg__BuildingMap__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[5].fields = rmf_building_map_msgs__msg__Level__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = rmf_building_map_msgs__msg__Lift__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[7].fields = rmf_building_map_msgs__msg__Param__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = rmf_building_map_msgs__msg__Place__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
rmf_building_map_msgs__msg__BuildingMap__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_building_map_msgs__msg__BuildingMap__get_individual_type_description_source(NULL),
    ...
    sources[6] = *rmf_building_map_msgs__msg__Level__get_individual_type_description_source(NULL);
    sources[7] = *rmf_building_map_msgs__msg__Lift__get_individual_type_description_source(NULL);
    sources[8] = *rmf_building_map_msgs__msg__Param__get_individual_type_description_source(NULL);
    sources[9] = *rmf_building_map_msgs__msg__Place__get_individual_type_description_source(NULL);
    constructed = true;
  }
