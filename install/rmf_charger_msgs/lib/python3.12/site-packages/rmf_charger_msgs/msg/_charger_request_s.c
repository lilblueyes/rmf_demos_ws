...
bool rmf_charger_msgs__msg__charger_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_charger_msgs.msg._charger_request.ChargerRequest", full_classname_dest, 52) == 0);
  }
  rmf_charger_msgs__msg__ChargerRequest * ros_message = _ros_message;
  {  // charger_name
...
{
  /* NOTE(esteve): Call constructor of ChargerRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_charger_msgs.msg._charger_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChargerRequest");
