    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rmf_obstacle_msgs.msg.Obstacles')
            logger.debug(
            ...
            from rmf_obstacle_msgs.msg import Obstacle
...
class Obstacles(metaclass=Metaclass_Obstacles):
    ...
    _fields_and_field_types = {
        ...
        'obstacles': 'sequence<rmf_obstacle_msgs/Obstacle>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rmf_obstacle_msgs', 'msg'], 'Obstacle')),  # noqa: E501
    )
