...
bool rmf_obstacle_msgs__msg__bounding_box3_d__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool rmf_obstacle_msgs__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_obstacle_msgs.msg._obstacle.Obstacle", full_classname_dest, 40) == 0);
  }
  rmf_obstacle_msgs__msg__Obstacle * ros_message = _ros_message;
  {  // header
  ...
  {  // classification
    ...
    rosidl_runtime_c__String__assign(&ros_message->classification, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // bbox
    ...
    if (!rmf_obstacle_msgs__msg__bounding_box3_d__convert_from_py(field, &ros_message->bbox)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // data_resolution
    PyObject * field = PyObject_GetAttrString(_pymsg, "data_resolution");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->data_resolution = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // data
...
PyObject * rmf_obstacle_msgs__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_obstacle_msgs.msg._obstacle");
  ...
  {  // classification
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->classification.data,
      strlen(ros_message->classification.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // bbox
    PyObject * field = NULL;
    field = rmf_obstacle_msgs__msg__bounding_box3_d__convert_to_py(&ros_message->bbox);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // data_resolution
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->data_resolution);
    {
      int rc = PyObject_SetAttrString(_pymessage, "data_resolution", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
