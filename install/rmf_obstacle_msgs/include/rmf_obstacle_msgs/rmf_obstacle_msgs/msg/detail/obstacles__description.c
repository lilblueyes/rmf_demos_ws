  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x7b, 0x96, 0xbb, 0xe6, 0xa3, 0x31, 0x62, 0xd9,
      0xad, 0x6d, 0x75, 0x1b, 0x8f, 0x08, 0xdb, 0xaa,
      0x32, 0xc2, 0x3c, 0x5b, 0x4a, 0x89, 0x42, 0xc7,
      0x8d, 0x52, 0x49, 0xf4, 0x84, 0x43, 0xb7, 0x01,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t rmf_obstacle_msgs__msg__Obstacle__EXPECTED_HASH = {1, {
...
static char rmf_obstacle_msgs__msg__Obstacles__TYPE_NAME[] = "rmf_obstacle_msgs/msg/Obstacles";
...
static char rmf_obstacle_msgs__msg__Obstacles__FIELD_NAME__header[] = "header";
static char rmf_obstacle_msgs__msg__Obstacles__FIELD_NAME__obstacles[] = "obstacles";

static rosidl_runtime_c__type_description__Field rmf_obstacle_msgs__msg__Obstacles__FIELDS[] = {
  {
    {rmf_obstacle_msgs__msg__Obstacles__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {rmf_obstacle_msgs__msg__Obstacles__FIELD_NAME__obstacles, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rmf_obstacle_msgs__msg__Obstacles__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rmf_obstacle_msgs__msg__Obstacles__TYPE_NAME, 31, 31},
      {rmf_obstacle_msgs__msg__Obstacles__FIELDS, 2, 2},
    },
    {rmf_obstacle_msgs__msg__Obstacles__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&rmf_obstacle_msgs__msg__Obstacle__EXPECTED_HASH, rmf_obstacle_msgs__msg__Obstacle__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[7].fields = rmf_obstacle_msgs__msg__Obstacle__get_type_description(NULL)->type_description.fields;
...
rmf_obstacle_msgs__msg__Obstacles__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rmf_obstacle_msgs__msg__Obstacles__get_individual_type_description_source(NULL),
    ...
    sources[8] = *rmf_obstacle_msgs__msg__Obstacle__get_individual_type_description_source(NULL);
