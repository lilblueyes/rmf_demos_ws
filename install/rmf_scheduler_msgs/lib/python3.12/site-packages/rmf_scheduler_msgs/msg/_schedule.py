...
class Metaclass_Schedule(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'FINISH_AT__DEFAULT': 9223372036854775807,
            'GROUP__DEFAULT': 'default',
        }

    @property
    def FINISH_AT__DEFAULT(cls):
        """Return default value for message field 'finish_at'."""
...
class Schedule(metaclass=Metaclass_Schedule):
    ...
    def __init__(self, **kwargs):
        ...
        self.start_at = kwargs.get('start_at', int())
        self.finish_at = kwargs.get(
            'finish_at', Schedule.FINISH_AT__DEFAULT)
        self.group = kwargs.get(
            'group', Schedule.GROUP__DEFAULT)
        from rmf_scheduler_msgs.msg import Payload
    ...
    def __eq__(self, other):
        ...
        if self.start_at != other.start_at:
            return False
        if self.finish_at != other.finish_at:
            return False
    ...
    def start_at(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'start_at' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'start_at' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._start_at = value

    @builtins.property
    def finish_at(self):
        """Message field 'finish_at'."""
        return self._finish_at

    @finish_at.setter
    def finish_at(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'finish_at' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'finish_at' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._finish_at = value
