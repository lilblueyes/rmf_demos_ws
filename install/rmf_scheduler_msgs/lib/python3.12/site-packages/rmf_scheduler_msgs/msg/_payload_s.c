...
bool rmf_scheduler_msgs__msg__payload__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_scheduler_msgs.msg._payload.Payload", full_classname_dest, 39) == 0);
  }
  rmf_scheduler_msgs__msg__Payload * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of Payload */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_scheduler_msgs.msg._payload");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Payload");
  ...
  rmf_scheduler_msgs__msg__Payload * ros_message = (rmf_scheduler_msgs__msg__Payload *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
