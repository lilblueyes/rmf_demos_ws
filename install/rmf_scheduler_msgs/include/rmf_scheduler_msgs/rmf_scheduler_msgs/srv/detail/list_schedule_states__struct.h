...
enum
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ListScheduleStates in the package rmf_scheduler_msgs.
typedef struct rmf_scheduler_msgs__srv__ListScheduleStates_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence request;
  rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence response;
} rmf_scheduler_msgs__srv__ListScheduleStates_Event;

// Struct for a sequence of rmf_scheduler_msgs__srv__ListScheduleStates_Event.
typedef struct rmf_scheduler_msgs__srv__ListScheduleStates_Event__Sequence
{
