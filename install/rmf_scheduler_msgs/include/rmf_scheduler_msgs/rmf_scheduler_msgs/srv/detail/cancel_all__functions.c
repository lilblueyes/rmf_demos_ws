...
rmf_scheduler_msgs__srv__CancelAll_Request__init(rmf_scheduler_msgs__srv__CancelAll_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->group)) {
    rmf_scheduler_msgs__srv__CancelAll_Request__fini(msg);
    return false;
  }
  return true;
}
...
rmf_scheduler_msgs__srv__CancelAll_Request__create(void)
{
  ...
  rmf_scheduler_msgs__srv__CancelAll_Request * msg = (rmf_scheduler_msgs__srv__CancelAll_Request *)allocator.allocate(sizeof(rmf_scheduler_msgs__srv__CancelAll_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmf_scheduler_msgs__srv__CancelAll_Request));
  bool success = rmf_scheduler_msgs__srv__CancelAll_Request__init(msg);
  if (!success) {
...
rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__init(rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Request * data = NULL;

  if (size) {
    data = (rmf_scheduler_msgs__srv__CancelAll_Request *)allocator.zero_allocate(size, sizeof(rmf_scheduler_msgs__srv__CancelAll_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmf_scheduler_msgs__srv__CancelAll_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rmf_scheduler_msgs__srv__CancelAll_Request__fini(&data[i - 1]);
      }
...
rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__fini(rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rmf_scheduler_msgs__srv__CancelAll_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * array = (rmf_scheduler_msgs__srv__CancelAll_Request__Sequence *)allocator.allocate(sizeof(rmf_scheduler_msgs__srv__CancelAll_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__init(array, size);
  if (!success) {
...
rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__destroy(rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__are_equal(const rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * lhs, const rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmf_scheduler_msgs__srv__CancelAll_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmf_scheduler_msgs__srv__CancelAll_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmf_scheduler_msgs__srv__CancelAll_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rmf_scheduler_msgs__srv__CancelAll_Request * data =
      (rmf_scheduler_msgs__srv__CancelAll_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmf_scheduler_msgs__srv__CancelAll_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rmf_scheduler_msgs__srv__CancelAll_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmf_scheduler_msgs__srv__CancelAll_Request__copy(
...
rmf_scheduler_msgs__srv__CancelAll_Response__init(rmf_scheduler_msgs__srv__CancelAll_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    rmf_scheduler_msgs__srv__CancelAll_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Response * msg = (rmf_scheduler_msgs__srv__CancelAll_Response *)allocator.allocate(sizeof(rmf_scheduler_msgs__srv__CancelAll_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmf_scheduler_msgs__srv__CancelAll_Response));
  bool success = rmf_scheduler_msgs__srv__CancelAll_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__init(rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Response * data = NULL;

  if (size) {
    data = (rmf_scheduler_msgs__srv__CancelAll_Response *)allocator.zero_allocate(size, sizeof(rmf_scheduler_msgs__srv__CancelAll_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmf_scheduler_msgs__srv__CancelAll_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rmf_scheduler_msgs__srv__CancelAll_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__fini(rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rmf_scheduler_msgs__srv__CancelAll_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * array = (rmf_scheduler_msgs__srv__CancelAll_Response__Sequence *)allocator.allocate(sizeof(rmf_scheduler_msgs__srv__CancelAll_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__destroy(rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__are_equal(const rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * lhs, const rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmf_scheduler_msgs__srv__CancelAll_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmf_scheduler_msgs__srv__CancelAll_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmf_scheduler_msgs__srv__CancelAll_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rmf_scheduler_msgs__srv__CancelAll_Response * data =
      (rmf_scheduler_msgs__srv__CancelAll_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmf_scheduler_msgs__srv__CancelAll_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rmf_scheduler_msgs__srv__CancelAll_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmf_scheduler_msgs__srv__CancelAll_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rmf_scheduler_msgs__srv__CancelAll_Event__init(rmf_scheduler_msgs__srv__CancelAll_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    rmf_scheduler_msgs__srv__CancelAll_Event__fini(msg);
    return false;
  }
  // request
  if (!rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__init(&msg->request, 0)) {
    rmf_scheduler_msgs__srv__CancelAll_Event__fini(msg);
    return false;
  }
  // response
  if (!rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__init(&msg->response, 0)) {
    rmf_scheduler_msgs__srv__CancelAll_Event__fini(msg);
    return false;
  }
  return true;
...
rmf_scheduler_msgs__srv__CancelAll_Event__fini(rmf_scheduler_msgs__srv__CancelAll_Event * msg)
{
  ...
  // request
  rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__fini(&msg->request);
  // response
  rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__fini(&msg->response);
}
...
rmf_scheduler_msgs__srv__CancelAll_Event__are_equal(const rmf_scheduler_msgs__srv__CancelAll_Event * lhs, const rmf_scheduler_msgs__srv__CancelAll_Event * rhs)
{
  ...
  // request
  if (!rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__are_equal(
  ...
  rmf_scheduler_msgs__srv__CancelAll_Event * output)
{
  ...
  // request
  if (!rmf_scheduler_msgs__srv__CancelAll_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!rmf_scheduler_msgs__srv__CancelAll_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Event * msg = (rmf_scheduler_msgs__srv__CancelAll_Event *)allocator.allocate(sizeof(rmf_scheduler_msgs__srv__CancelAll_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmf_scheduler_msgs__srv__CancelAll_Event));
  bool success = rmf_scheduler_msgs__srv__CancelAll_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rmf_scheduler_msgs__srv__CancelAll_Event__Sequence__init(rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Event * data = NULL;

  if (size) {
    data = (rmf_scheduler_msgs__srv__CancelAll_Event *)allocator.zero_allocate(size, sizeof(rmf_scheduler_msgs__srv__CancelAll_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmf_scheduler_msgs__srv__CancelAll_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rmf_scheduler_msgs__srv__CancelAll_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rmf_scheduler_msgs__srv__CancelAll_Event__Sequence__fini(rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rmf_scheduler_msgs__srv__CancelAll_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * array = (rmf_scheduler_msgs__srv__CancelAll_Event__Sequence *)allocator.allocate(sizeof(rmf_scheduler_msgs__srv__CancelAll_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmf_scheduler_msgs__srv__CancelAll_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rmf_scheduler_msgs__srv__CancelAll_Event__Sequence__destroy(rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmf_scheduler_msgs__srv__CancelAll_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmf_scheduler_msgs__srv__CancelAll_Event__Sequence__are_equal(const rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * lhs, const rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmf_scheduler_msgs__srv__CancelAll_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmf_scheduler_msgs__srv__CancelAll_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmf_scheduler_msgs__srv__CancelAll_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rmf_scheduler_msgs__srv__CancelAll_Event * data =
      (rmf_scheduler_msgs__srv__CancelAll_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmf_scheduler_msgs__srv__CancelAll_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rmf_scheduler_msgs__srv__CancelAll_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmf_scheduler_msgs__srv__CancelAll_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
