...
#ifndef RMF_SCHEDULER_MSGS__SRV__DETAIL__LIST_SCHEDULES__FUNCTIONS_H_
#define RMF_SCHEDULER_MSGS__SRV__DETAIL__LIST_SCHEDULES__FUNCTIONS_H_
...
/// Initialize srv/ListSchedules message.
/**
 ...
 * )) before or use
 * rmf_scheduler_msgs__srv__ListSchedules_Request__create()
...
/// Finalize srv/ListSchedules message.
/**
...
/// Create srv/ListSchedules message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_scheduler_msgs__srv__ListSchedules_Request__init().
...
/// Destroy srv/ListSchedules message.
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Request__fini()
...
/// Check for srv/ListSchedules message equality.
/**
...
/// Copy a srv/ListSchedules message.
/**
...
/// Initialize array of srv/ListSchedules messages.
/**
...
/// Finalize array of srv/ListSchedules messages.
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Request__fini()
...
/// Create array of srv/ListSchedules messages.
/**
 * It allocates the memory for the array and calls
 * rmf_scheduler_msgs__srv__ListSchedules_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ListSchedules messages.
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ListSchedules message array equality.
/**
...
/// Copy an array of srv/ListSchedules messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * rmf_scheduler_msgs__srv__ListSchedules_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_scheduler_msgs__srv__ListSchedules_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
...
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
...
/**
 * It allocates the memory for the array and calls
 * rmf_scheduler_msgs__srv__ListSchedules_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
...
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * rmf_scheduler_msgs__srv__ListSchedules_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmf_scheduler_msgs__srv__ListSchedules_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
...
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
...
/**
 * It allocates the memory for the array and calls
 * rmf_scheduler_msgs__srv__ListSchedules_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmf_scheduler_msgs
...
/**
 * It calls
 * rmf_scheduler_msgs__srv__ListSchedules_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RMF_SCHEDULER_MSGS__SRV__DETAIL__LIST_SCHEDULES__FUNCTIONS_H_
