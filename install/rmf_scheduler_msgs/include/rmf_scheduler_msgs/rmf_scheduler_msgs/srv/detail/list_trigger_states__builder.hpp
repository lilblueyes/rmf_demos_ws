...
class Init_ListTriggerStates_Event_response
{
public:
  explicit Init_ListTriggerStates_Event_response(::rmf_scheduler_msgs::srv::ListTriggerStates_Event & msg)
  : msg_(msg)
  {}
  ::rmf_scheduler_msgs::srv::ListTriggerStates_Event response(::rmf_scheduler_msgs::srv::ListTriggerStates_Event::_response_type arg)
  {
...
private:
  ::rmf_scheduler_msgs::srv::ListTriggerStates_Event msg_;
};

class Init_ListTriggerStates_Event_request
{
public:
  explicit Init_ListTriggerStates_Event_request(::rmf_scheduler_msgs::srv::ListTriggerStates_Event & msg)
  : msg_(msg)
  {}
  Init_ListTriggerStates_Event_response request(::rmf_scheduler_msgs::srv::ListTriggerStates_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_ListTriggerStates_Event_response(msg_);
  }
...
class Init_ListTriggerStates_Event_info
{
public:
  Init_ListTriggerStates_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ListTriggerStates_Event_request info(::rmf_scheduler_msgs::srv::ListTriggerStates_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_ListTriggerStates_Event_request(msg_);
  }
...
template<>
inline
auto build<::rmf_scheduler_msgs::srv::ListTriggerStates_Event>()
{
  return rmf_scheduler_msgs::srv::builder::Init_ListTriggerStates_Event_info();
}
