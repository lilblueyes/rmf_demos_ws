...
void rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__init(message_memory);
}

void rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_fini_function(void * message_memory)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__fini(message_memory);
}

size_t rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__size_function__ListScheduleStates_Event__request(
  const void * untyped_member)
{
  const rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence * member =
    (const rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_const_function__ListScheduleStates_Event__request(
  const void * untyped_member, size_t index)
{
  const rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence * member =
    (const rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence *)(untyped_member);
...
void * rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_function__ListScheduleStates_Event__request(
  void * untyped_member, size_t index)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence * member =
    (rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__fetch_function__ListScheduleStates_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rmf_scheduler_msgs__srv__ListScheduleStates_Request * item =
    ((const rmf_scheduler_msgs__srv__ListScheduleStates_Request *)
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_const_function__ListScheduleStates_Event__request(untyped_member, index));
  rmf_scheduler_msgs__srv__ListScheduleStates_Request * value =
    (rmf_scheduler_msgs__srv__ListScheduleStates_Request *)(untyped_value);
  *value = *item;
}

void rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__assign_function__ListScheduleStates_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Request * item =
    ((rmf_scheduler_msgs__srv__ListScheduleStates_Request *)
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_function__ListScheduleStates_Event__request(untyped_member, index));
  const rmf_scheduler_msgs__srv__ListScheduleStates_Request * value =
    (const rmf_scheduler_msgs__srv__ListScheduleStates_Request *)(untyped_value);
  *item = *value;
}

bool rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__resize_function__ListScheduleStates_Event__request(
  void * untyped_member, size_t size)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence * member =
    (rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence *)(untyped_member);
  rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence__fini(member);
  return rmf_scheduler_msgs__srv__ListScheduleStates_Request__Sequence__init(member, size);
}

size_t rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__size_function__ListScheduleStates_Event__response(
  const void * untyped_member)
{
  const rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence * member =
    (const rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_const_function__ListScheduleStates_Event__response(
  const void * untyped_member, size_t index)
{
  const rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence * member =
    (const rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence *)(untyped_member);
...
void * rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_function__ListScheduleStates_Event__response(
  void * untyped_member, size_t index)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence * member =
    (rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__fetch_function__ListScheduleStates_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rmf_scheduler_msgs__srv__ListScheduleStates_Response * item =
    ((const rmf_scheduler_msgs__srv__ListScheduleStates_Response *)
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_const_function__ListScheduleStates_Event__response(untyped_member, index));
  rmf_scheduler_msgs__srv__ListScheduleStates_Response * value =
    (rmf_scheduler_msgs__srv__ListScheduleStates_Response *)(untyped_value);
  *value = *item;
}

void rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__assign_function__ListScheduleStates_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Response * item =
    ((rmf_scheduler_msgs__srv__ListScheduleStates_Response *)
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_function__ListScheduleStates_Event__response(untyped_member, index));
  const rmf_scheduler_msgs__srv__ListScheduleStates_Response * value =
    (const rmf_scheduler_msgs__srv__ListScheduleStates_Response *)(untyped_value);
  *item = *value;
}

bool rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__resize_function__ListScheduleStates_Event__response(
  void * untyped_member, size_t size)
{
  rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence * member =
    (rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence *)(untyped_member);
  rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence__fini(member);
  return rmf_scheduler_msgs__srv__ListScheduleStates_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmf_scheduler_msgs__srv__ListScheduleStates_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rmf_scheduler_msgs__srv__ListScheduleStates_Event, request),  // bytes offset in struct
    NULL,  // default value
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__size_function__ListScheduleStates_Event__request,  // size() function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_const_function__ListScheduleStates_Event__request,  // get_const(index) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_function__ListScheduleStates_Event__request,  // get(index) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__fetch_function__ListScheduleStates_Event__request,  // fetch(index, &value) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__assign_function__ListScheduleStates_Event__request,  // assign(index, value) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__resize_function__ListScheduleStates_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rmf_scheduler_msgs__srv__ListScheduleStates_Event, response),  // bytes offset in struct
    NULL,  // default value
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__size_function__ListScheduleStates_Event__response,  // size() function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_const_function__ListScheduleStates_Event__response,  // get_const(index) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__get_function__ListScheduleStates_Event__response,  // get(index) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__fetch_function__ListScheduleStates_Event__response,  // fetch(index, &value) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__assign_function__ListScheduleStates_Event__response,  // assign(index, value) function pointer
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__resize_function__ListScheduleStates_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_members = {
  "rmf_scheduler_msgs__srv",  // message namespace
  "ListScheduleStates_Event",  // message name
  3,  // number of fields
  sizeof(rmf_scheduler_msgs__srv__ListScheduleStates_Event),
  false,  // has_any_key_member_
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_member_array,  // message members
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_type_support_handle = {
  0,
  &rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rmf_scheduler_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Event)() {
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Request)();
  rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Response)();
  if (!rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_type_support_handle.typesupport_identifier) {
    rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t rmf_scheduler_msgs__srv__detail__list_schedule_states__rosidl_typesupport_introspection_c__ListScheduleStates_service_type_support_handle = {
  ...
  &rmf_scheduler_msgs__srv__ListScheduleStates_Request__rosidl_typesupport_introspection_c__ListScheduleStates_Request_message_type_support_handle,
  &rmf_scheduler_msgs__srv__ListScheduleStates_Response__rosidl_typesupport_introspection_c__ListScheduleStates_Response_message_type_support_handle,
  &rmf_scheduler_msgs__srv__ListScheduleStates_Event__rosidl_typesupport_introspection_c__ListScheduleStates_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rmf_scheduler_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, ListScheduleStates_Event)()->data;
  }
