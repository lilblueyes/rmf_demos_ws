...
inline void to_flow_style_yaml(
  const CreateSchedule_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const CreateSchedule_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rmf_scheduler_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rmf_scheduler_msgs::srv::CreateSchedule_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rmf_scheduler_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rmf_scheduler_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rmf_scheduler_msgs::srv::CreateSchedule_Event & msg)
{
  return rmf_scheduler_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rmf_scheduler_msgs::srv::CreateSchedule_Event>()
{
  return "rmf_scheduler_msgs::srv::CreateSchedule_Event";
}

template<>
inline const char * name<rmf_scheduler_msgs::srv::CreateSchedule_Event>()
{
  return "rmf_scheduler_msgs/srv/CreateSchedule_Event";
}

template<>
struct has_fixed_size<rmf_scheduler_msgs::srv::CreateSchedule_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rmf_scheduler_msgs::srv::CreateSchedule_Event>
  : std::integral_constant<bool, has_bounded_size<rmf_scheduler_msgs::srv::CreateSchedule_Request>::value && has_bounded_size<rmf_scheduler_msgs::srv::CreateSchedule_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rmf_scheduler_msgs::srv::CreateSchedule_Event>
  : std::true_type {};
