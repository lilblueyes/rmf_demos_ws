...
: ${AMENT_CURRENT_PREFIX:="/rmf_demos_ws/install/rmf_reservation_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_reservation_node/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_reservation_node/environment/path.sh"
