...
bool rmf_site_map_msgs__msg__site_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmf_site_map_msgs.msg._site_map.SiteMap", full_classname_dest, 39) == 0);
  }
  rmf_site_map_msgs__msg__SiteMap * ros_message = _ros_message;
  {  // encoding
    ...
    ros_message->encoding = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
PyObject * rmf_site_map_msgs__msg__site_map__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmf_site_map_msgs.msg._site_map");
